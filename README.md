...
```javascript
import dapxsum from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dapxsum@v0.3.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dapxsum/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-dapxsum/actions/workflows/test.yml?query=branch:v0.3.1
